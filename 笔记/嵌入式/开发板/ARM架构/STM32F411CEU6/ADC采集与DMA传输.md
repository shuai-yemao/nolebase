...
![[Pasted image 20260329193114.png]]
...
#### 辅助图示
 ...
 1. ADC 采集流程 ![[Pasted image 20251008150946.png]]
 2. ADC 框图 ![[Pasted image 20260325162305.png]]
3. 流水线 ADC
![ADC转换过程](https://i-blog.csdnimg.cn/blog_migrate/9d4a4b1bb33af4336ccba96adb8db55b.png)![[Pasted image 20260328215204.png]]

4. 逐次比较型 ADC ![[Pasted image 20251008151652.png]]
5. 并行比较型 ADC ![[Pasted image 20251008151933.png]]
6. ∑-Δ型 ![[Pasted image 20251008152405.png]]
7. 积分型 ADC![](https://i-blog.csdnimg.cn/blog_migrate/2fa0de08cf63e16095b919eab1c2d450.png)![[Pasted image 20260328215117.png]]
8. ADC 输入电压范围 ![[Pasted image 20251008160543.png]]
9. 单端输入
...
1. 系统总线矩阵 ![[Pasted image 20260327180026.png]]
2. DMA 整体结构框图 ![[Pasted image 20260327173451.png]]
3. DMA 与总线的链接图 ![[Pasted image 20260327175200.png]]
4. 不同通道和不同数据流的 DMA 请求 ![[Pasted image 20260327173643.png]] ![[Pasted image 20260327173655.png]]
5. FIFO 和仲裁器 ![[Pasted image 20260327173732.png]] ![[Pasted image 20260327173811.png]]
6. FIFO 和 Burst ![[Pasted image 20260327173921.png]]
7. DMA 中断请求 ![[Pasted image 20260403130624.png]]
...
1. Draw 程序架构逻辑图 ![[Pasted image 20260328154333.png]]
2. 代码静态分析图 ![[Pasted image 20260328201710.png]]
3. 代码内存窗口 ![[Pasted image 20260328153324.png]]
4. RTT 观察窗口 ![[Pasted image 20260328152251.png]]
...
A 7: EOCSelection 参数是来选择 ADC 转换一个发送一个还是全部转换完毕再发送 ![[Pasted image 20260328212325.png]] 位于 ADC_CR 2 寄存器上

### Q 8：ADC 采样为什么采样时间越长越准确？能从 ADC 的构造解释一下吗？

A 8: ADC 采样时间取决于采样电路的电容充电时间，==所有的通道共用一个采样保持电容== ![[Pasted image 20260328214352.png]] 当采样时间不够时，Cadc 上的电压与 Vain 不一致会导致转换结果偏大 ![[Pasted image 20260328214620.png]]
