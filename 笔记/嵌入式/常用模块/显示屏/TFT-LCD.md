### 原子 2.4寸显示模块 ATK-MD0240。
这款显示模块的 LCD分辨率为 320 * 240，支持 16 位真彩色显示。模块采用 ST7789V 作为 LCD的驱动芯片，该芯片自带 RAM，无需外加驱动器或存储器。使用外接的主控芯片时，仅需使用 [[嵌入式/通信协议/有线通信协议/SPI|SPI]] 接口就可以轻松地驱动这个显示模块。
#### 原理图
![[Pasted image 20251007160248.png]]
![[Pasted image 20251007160333.png]]
#### 显存和初始化
